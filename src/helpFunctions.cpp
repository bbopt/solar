...
/*-----------------------------------------------*/
  ...
  out << "\n-----------------------------------------------------------------\n"
      ...
      << "\t\tx8: Minimum distance to tower (% of tower height): Real in [0;20]\n"
      << "\t\tx9: Maximum distance to tower (% of tower height): Real in [0;20]\n"
      << std::endl
...
/*-----------------------------------------------*/
  ...
  out << "\n-----------------------------------------------------------------\n"
      ...
      << "\t\t x7: Field max. angular span (deg)                : Real in [1;89]\n"
      << "\t\t x8: Minimum distance to tower (% of tower height): Real in [0;20]\n"
      << "\t\t x9: Maximum distance to tower (% of tower height): Real in [1;20]\n"
      << "\tHeat transfer loop:\n"
      ...
      << "\tc11: Receiver inside diameter   <= outside diameter\n"
...
/*-----------------------------------------------*/  
  out << "\n-----------------------------------------------------------------\n"
      ...
      << "\tc10: Tubes inside diameter is smaller than outer diameter\n"
...
/*-----------------------------------------------*/
  out << "\n-----------------------------------------------------------------\n"
      ...
      << "\t\tx27: Number of shells           : Integer in {1, 2, ..., 10}\n"
...
/*-----------------------------------------------*/
  ...
  out << "Variables:\n"
      ...
      << "\tc3: Tubes inside diameter <= tubes outside diameter\n"
...
/*-----------------------------------------------*/
  ...
  out << "Variables:\n"
      ...
      << "\tc4: Number of heliostats   <= x6\n"
      << "\tc5: Pressure in receiver tubes <= yield pressure (stochastic)\n"
      << "\tc6: Tubes inside diameter   <= tubes outside diameter\n"
